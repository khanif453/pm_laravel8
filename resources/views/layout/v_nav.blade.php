...
<li class="nav-item">
    <a href="{{ route('admin.users.index') }}"><i class="fa fa-user-plus"></i><span> Admin</span></a>
</li>
<li class="nav-item">
    <a href="{{ route('admin.users.indexPetugas') }}"><i class="fa fa-user"></i><span> Petugas</span></a>
</li>
<li class="nav-item">
