  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="mt-4">
          <a href="{{ route('admin.petugas.createPetugas') }}" class="btn btn-primary">
            <i class="fa fa-plus-square"></i> Tambah Petugas</a>
        </div>
        <div class="mt-3">
          @if (session('pesan'))
        ...
        <table class="table table-bordered" id="example1" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $p->level }}</td>
              <td>
                <a href="{{ route('admin.petugas.edit', $p->id) }}" class="btn btn-warning">
